...
namespace CBM.Views {
  public partial class BrandForm : Form {
    ...
    private void CssLabel() {
      ...
      UserControlUtils.CssFieldLabel(logoLabel);
    ...
    private void CssTextbox() {
      UserControlUtils.CssTextbox(nameField, "Enter brand's name");
      UserControlUtils.CssTextbox(descriptionField, "Enter brand's description");
      UserControlUtils.CssSearchTextbox(searchField);
    }
    private void CssIconPictureBox() {
      logoPictureBox.Click += UploadLogo;
      logoPictureBox.IconColor = ColorTranslator.FromHtml("#183153");
      logoPictureBox.ForeColor = ColorTranslator.FromHtml("#183153");
    }
    ...
    public void MapDataSource(BindingSource bindingSource) {
      ...
      dataGridView.Columns["logo"].Visible = false;
    ...
    private void AssociateEvents() {
      ...
      createBtn.Click += delegate {
        ...
        validationBindingSource.DataSource = new Brand();
      ...
      saveBtn.Click += delegate {
        ...
        Brand validated = validationBindingSource.Current as Brand;
      ...
      dataGridView.CellClick += delegate (object sender, DataGridViewCellEventArgs e) {
        ...
        if (e.ColumnIndex == 0) {
          ...
          validatedBrand.name = name;
          validatedBrand.description = description;
          validationBindingSource.DataSource = validatedBrand;
          SwitchToDetailTab();
          errorProvider.Clear();
        }
        if (e.ColumnIndex == 1) {
    ...
    private void UploadLogo(object sender, EventArgs e) {
      OpenFileDialog opnfd = new OpenFileDialog();
      opnfd.Filter = "Image Files (*.png;*.jpg;*.jpeg;.*.gif;)|*.png;*.jpg;*.jpeg;.*.gif";
      if (opnfd.ShowDialog() == DialogResult.OK) {
        logoPictureBox.Image = new Bitmap(opnfd.FileName);
        logoFilename = opnfd.FileName;
      }
    }
