...
namespace CBM.Views {
  public partial class MarketplaceLoginView : Form {
    ...
    private void CssLabel() {
      ...
      signupLabel.ForeColor = ColorTranslator.FromHtml(Constant.RED_COLOR);
      signupLabel.Font = new Font(Constant.FONT_FAMILY, Constant.NORMAL_FONT_SIZE, FontStyle.Underline);
    ...
    private void AssociateEvents() {
      ...
      signupLabel.Click += delegate {
        MarketplaceSignupView signupView = new MarketplaceSignupView();
        new MarketplaceSignupPresenter(signupView);
        signupView.Show();
        this.Hide();
      };
      ...
      loginBtn.Click += delegate {
        ...
        if (validated.IsValid) {
          ...
          if (isSuccessful) {
            MarketplaceCommonView commonView = new MarketplaceCommonView(this);
            commonView.Show();
            this.Hide();
            messageLabel.Visible = false;
          }
