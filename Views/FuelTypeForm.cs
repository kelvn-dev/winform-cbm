...
namespace CBM.Views {
  public partial class FuelTypeForm : Form {
    ...
    private void CssTextbox() {
      UserControlUtils.CssTextbox(nameField, "Enter fuel type's name");
      UserControlUtils.CssTextbox(descriptionField, "Enter fuel type's description");
    ...
    private void AssociateEvents() {
      ...
      createBtn.Click += delegate {
        ...
        validationBindingSource.DataSource = new FuelType();
      ...
      saveBtn.Click += delegate {
        ...
        FuelType validated = validationBindingSource.Current as FuelType;
      ...
      dataGridView.CellClick += delegate (object sender, DataGridViewCellEventArgs e) {
        ...
        if (e.ColumnIndex == 0) {
          ...
          FuelType validation = new FuelType();
