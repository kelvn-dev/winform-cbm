...
namespace CBM.Views {
  public partial class VehicleTypeForm : Form {
    ...
    private void CssTextbox() {
      UserControlUtils.CssTextbox(nameField, "Enter vehicle type's name");
      UserControlUtils.CssTextbox(descriptionField, "Enter vehicle type's description");
    ...
    private void AssociateEvents() {
      ...
      createBtn.Click += delegate {
        ...
        validationBindingSource.DataSource = new VehicleType();
      ...
      saveBtn.Click += delegate {
        ...
        VehicleType validated = validationBindingSource.Current as VehicleType;
      ...
      dataGridView.CellClick += delegate (object sender, DataGridViewCellEventArgs e) {
        ...
        if (e.ColumnIndex == 0) {
          ...
          VehicleType validation = new VehicleType();
