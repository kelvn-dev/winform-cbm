...
namespace CBM.Views {
  public partial class GroupForm : Form {
    ...
    private void CssTextbox() {
      UserControlUtils.CssTextbox(nameField, "Enter your name");
      UserControlUtils.CssTextbox(descriptionField, "Enter your description");
    ...
    private void AssociateEvents() {
      ...
      createBtn.Click += delegate {
        validationBindingSource.DataSource = new Group();
      ...
      saveBtn.Click += delegate {
        ...
        Group validated = validationBindingSource.Current as Group;
