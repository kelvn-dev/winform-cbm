...
namespace CBM.Views {
  public partial class HomeForm : Form {
    ...
    public HomeForm(Administrator administrator) {
      InitializeComponent();
      ...
      id = administrator.id;
      informationLabel.Text += administrator.username;
      //username = administrator.username.Trim();
      //email = administrator.email.Trim();
      //phone = administrator.phone.Trim();
      //address = administrator.address.Trim();
      //zipcode = administrator.zipcode.Trim();
      //if (administrator.avatar != null) {
      //  MemoryStream stream = new MemoryStream(administrator.avatar);
    ...
    private void AssociateValidation() {
      validationBindingSource.DataSource = administrator;
